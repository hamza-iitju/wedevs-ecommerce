function HSDemo() {
  ...
  if (skin && headerMode !== 'double' && headerMode !== 'double-container') {
    ...
    if (skin === 'navbar-light') {
      ...
      if (sidebar) {
        for (var i = 0; i < document.querySelectorAll('aside .navbar-publication-logo').length; i++) {
          document.querySelectorAll('aside .navbar-publication-logo')[i].setAttribute('src', document.querySelectorAll('aside .navbar-publication-logo')[0].getAttribute('src').replace('logo.svg', 'logo-white.svg'));
        }
      } else {
        for (var i = 0; i < document.querySelectorAll('header .navbar-publication-logo').length; i++) {
          document.querySelectorAll('header .navbar-publication-logo')[i].setAttribute('src', document.querySelectorAll('header .navbar-publication-logo')[0].getAttribute('src').replace('logo.svg', 'logo-white.svg'));
        }
      }

      for (var i = 0; i < document.getElementsByClassName('navbar-publication-logo-mini').length; i++) {
        document.getElementsByClassName('navbar-publication-logo-mini')[i].setAttribute('src', document.getElementsByClassName('navbar-publication-logo-mini')[0].getAttribute('src').replace('logo-short.svg', 'logo-short-white.svg'));
      }

      for (var i = 0; i < document.getElementsByClassName('navbar-publication-logo-short').length; i++) {
        document.getElementsByClassName('navbar-publication-logo-short')[i].setAttribute('src', document.getElementsByClassName('navbar-publication-logo-short')[0].getAttribute('src').replace('logo-short.svg', 'logo-short-white.svg'));
      }
    }
  }
