<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    ...
    <a class="card card-hover-shadow h-100" href="{{ route('admin.orders.list', ['pending']) }}"
        ...
        <div class="card-body">
            <h6 class="card-subtitle" style="color: white!important;">{{ __('messages.pending') }}</h6>
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    ...
    <a class="card card-hover-shadow h-100" href="{{ route('admin.orders.list', ['confirmed']) }}"
        ...
        <div class="card-body">
            <h6 class="card-subtitle" style="color: white!important;">{{ __('messages.confirmed') }}</h6>
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    ...
    <a class="card card-hover-shadow h-100" href="{{ route('admin.orders.list', ['processing']) }}"
        ...
        <div class="card-body">
            <h6 class="card-subtitle" style="color: white!important;">{{ __('messages.Processing') }}</h6>
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    <!-- Card -->
    <a class="card card-hover-shadow h-100" href="{{ route('admin.orders.list', ['outForDelivery']) }}"
        style="background: #343A40">
        <div class="card-body">
            <h6 class="card-subtitle" style="color: white!important;">{{ __('messages.outForDelivery') }}</h6>
