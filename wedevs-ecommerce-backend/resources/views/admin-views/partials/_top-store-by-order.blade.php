...
<div class="card-body">
    <div class="row">
        @foreach ($top_store_by_order_received as $key => $item)
            <div class="col-6 col-md-4 mt-2" style="padding-left: 6px;padding-right: 6px;cursor: pointer">
                <div class="grid-card" style="min-height: 170px">
                    ...
                    <center class="mt-6">
                        <img style="border-radius: 50%;width: 60px;height: 60px;border:2px solid #80808082;"
                            ...
                            src="{{ asset('storage/shop/shop.png') }}">
                    </center>
                    <div class="text-center mt-2">
                        <span style="font-size: 10px">Wedevs</span>
                    </div>
                </div>
            </div>
        @endforeach
