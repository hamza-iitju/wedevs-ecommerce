  ...
  <div class="col-lg-6 col-md-6">
    <div class="product-details-content">
      ...
      <ul class="product-info">
        <li><span>Vendor:</span> <a href="#">My Vendor</a></li>
        <li>
          <span>Availability:</span> <a href="#">In stock ({{ qty }})</a>
        </li>
        <li><span>Product Type:</span> <a href="#">Product Type</a></li>
      </ul>
      ...
      <div class="product-add-to-cart">
        ...
        <button v-if="qty <= 0" class="btn btn-error">
      ...
      <div class="wishlist-compare-btn">
        ...
        >
        <a href="#" class="btn btn-light"
          ><i class="fas fa-balance-scale"></i> Add to Compare</a
        >
      </div>
...
export default {
  ...
  props: ["id", "name", "price", "qty", "description"],
  computed: {
    cart() {
