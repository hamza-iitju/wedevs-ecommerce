          ...
          <div class="col-lg-5 col-md-12">
            <div class="contact-info">
              ...
              <ul class="contact-list">
                <li>
                  <i class="fas fa-map-marker-alt"></i> Location: Jahangirnagar
                  University, Savar, Dhaka-1342, Bangladesh
                </li>
                <li>
                  <i class="fas fa-phone"></i> Call Us:
                  <a href="#">+880 1744952899</a>
                </li>
                <li>
                  <i class="far fa-envelope"></i> Email Us:
                  <a href="#">hamza.iitju@gmail.com</a>
                </li>
              ...
              <ul class="opening-hours">
                <li><span>Sunday:</span> 8AM - 8PM</li>
                <li><span>Monday:</span> 8AM - 8PM</li>
                <li><span>Tuesday:</span> 8AM - 8PM</li>
                <li><span>Wednesday:</span> 8AM - 8PM</li>
                <li><span>Thursday:</span> 8AM - 8PM</li>
              </ul>
